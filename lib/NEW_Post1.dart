...
class NEW_Post1 extends StatefulWidget {
  const NEW_Post1({Key? key}) : super(key: key);

  @override
  State<NEW_Post1> createState() => _NEW_Post1State();
}

class _NEW_Post1State extends State<NEW_Post1> {
  ...
  final List<String> _type1 = ['Playstation','Playstation'];
            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // SizedBox(height: 15,),
                  // Text('Shipping Information',style: TextStyle(fontSize: 20,color: Colors.white)),
                  // Row(
                  //   children: [
                  //     Container(
                  //       height: 40,
                  ...
                  Container(
                    ...
                    child: DropdownButton<String>(
                      ...
                      onChanged: (value) {
                        ...
                        debugPrint("You selected $_selectedtype1");
                      },
                      hint: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                      ...
                      // Customize the selected item
                      selectedItemBuilder: (BuildContext context) => _type1
                          .map((e) =>
                          Center(
                            child: Text(
                              e,
